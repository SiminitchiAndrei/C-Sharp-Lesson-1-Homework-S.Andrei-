...
namespace C_Sharp_Lesson_1_Homework
{
    public class Homework
    {
        ...
        */
        ...
        public void CheckLetterIfVowelSwitch(char character)
        {
            /* Exercise 4
        ...
        public void CheckLetterIfVowelIf(char character)
        {
            /* Exercise 4
             * write a program that will print input character is a vowel, consonant or not a letter
             * Method 1: using a switch case
             ...
             * ---------------------------
             */
            if (char.ToLower(character) == 'a' || char.ToLower(character) == 'e' ||
                char.ToLower(character) == 'i' || char.ToLower(character) == 'o' ||
        ...
        public static void Main(String[] args)
        {
            ...
            //---------------------------------------
            homework.CheckLetterIfVowelSwitch('i');
            homework.CheckLetterIfVowelSwitch('L');
            homework.CheckLetterIfVowelSwitch('E');
            homework.CheckLetterIfVowelSwitch('m');

            homework.CheckLetterIfVowelIf('a');
            homework.CheckLetterIfVowelIf('B');
            homework.CheckLetterIfVowelIf('O');
            homework.CheckLetterIfVowelIf('n');
